  ...
  return (
    <div className="flex w-full items-center justify-end gap-3 sm:gap-5 text-white">
      <div className="flex flex-1 flex-col items-end justify-center text-right">
        <p className="text-[14px] sm:text-[16px] md:text-[18px] leading-tight" dir="rtl">
          {title}
        </p>
        <p
          className="text-[12px] sm:text-[13px] md:text-[15px] opacity-70 mt-1 leading-relaxed"
          dir="rtl"
        >
          {description}
        </p>
  ...
  const storeTypes = [
    {
      ...
      description:
        'تشمل متاجر الأغذية والمشروبات، حيث نركز على تحسين تجربة التسوق وتخفيف الازدحام.',
    ...
    },
    {
      ...
      description:
        'نقدم خدمات متدرجة تناسب حجم المتجر، مع التركيز على تحسين مستوى الخدمة وولاء العملاء.',
  ...
  return (
    <div className="w-full max-w-[500px] rounded-[15px] sm:rounded-[20px] bg-[#2c4653] px-4 sm:px-6 py-6 sm:py-8 md:py-10 block  lg:absolute z-[1000] left-[-90px] top-[-50px]">
      ...
      <div className="mb-6 sm:mb-8 md:mb-10 flex flex-col items-end justify-center text-right text-white">
        <p className="text-[20px] sm:text-[25px] md:text-[30px] leading-tight" dir="rtl">
          أنواع المتاجر المدعومة
        </p>
        <p className="text-[14px] sm:text-[17px] md:text-[20px] opacity-70 mt-1 sm:mt-2" dir="rtl">
          حلول مبتكرة لتجربة تسوق مثالية
        </p>
      </div>
