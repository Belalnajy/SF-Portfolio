          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                {/* Title */}
                <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-[#2c4653] mb-2" dir="auto">
                ...
                {/* Description */}
                <p className="text-sm md:text-base text-[rgba(44,70,83,0.8)] leading-relaxed mb-4" dir="auto">
