        ...
        <div className="container mx-auto px-6 lg:px-[40px]">
          ...
          <div className="hidden md:block">
            ...
            <div className="mb-8">
              <div className="grid grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-8 text-right">
                ...
                <div className="flex flex-col gap-2">
                  <h3
                    className="text-[#f9f9f9] text-[15px] font-bold mb-2 font-['Cairo:Bold',_sans-serif]"
                    dir="auto"
                  >
                    كن شريك النجاح
                  </h3>
                  <div className="flex flex-col gap-2 text-[rgba(249,249,249,0.65)] text-[12px] font-semibold font-['Cairo:SemiBold',_sans-serif]">
                    <Link
                      to="/employee"
                      className="hover:text-[#5dba47] transition-colors"
                      dir="auto"
                    >
                      سجل كموظف
                    </Link>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-col gap-2 text-[rgba(249,249,249,0.65)] text-[12px] font-semibold font-['Cairo:SemiBold',_sans-serif]">
                    <Link to="/about" className="hover:text-[#5dba47] transition-colors" dir="auto">
                      حول التطبيق
                    </Link>
                    <Link to="/" className="hover:text-[#5dba47] transition-colors" dir="auto">
                      الصفحة الرئيسية
                    </Link>
                    <button
                      onClick={handleDownloadApp}
                      className="hover:text-[#5dba47] transition-colors text-right cursor-pointer "
                      dir="auto"
                    >
                      تحميل التطبيق
                    </button>
            ...
            <div className="text-center pt-8 border-t border-[rgba(249,249,249,0.1)] mt-8">
              <p
                className="text-[rgba(249,249,249,0.65)] text-[12px] font-semibold font-['Cairo:SemiBold',_sans-serif]"
                dir="auto"
              >
          ...
          <div className="md:hidden">
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-6 mb-8 text-right">
              {/* Logo */}
              <img src="/logo.png" alt="S&F Logo" className="w-[120px] h-[43px] ms-10" />
              {/* Tagline */}
              <div className="text-right flex flex-col justify-center">
                <p
                  className="text-[#f9f9f9] text-[14px] font-bold font-['Cairo:Bold',_sans-serif] leading-tight"
                  dir="auto"
                >
                  لان وقتك أغلى
                </p>
                <p
                  className="text-[#5dba47] text-[14px] font-bold font-['Cairo:Bold',_sans-serif] leading-tight"
                  dir="auto"
                >
                  خليها تسوقك أسرع
                </p>
              ...
              <div className="flex flex-col gap-2">
                <h3
                  className="text-[#f9f9f9] text-[14px] font-bold mb-1 font-['Cairo:Bold',_sans-serif]"
                  dir="auto"
                >
                  الدعم
                </h3>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-1.5 text-[rgba(249,249,249,0.65)] text-[11px] font-semibold font-['Cairo:SemiBold',_sans-serif]">
                  ...
                  <Link to="/invest" className="hover:text-[#5dba47] transition-colors" dir="auto">
                    برنامج الاستثمار
                  </Link>
                </div>
              </div>
            ...
            <div className="text-center space-y-1">
              <p
                className="text-[rgba(249,249,249,0.65)] text-[10px] font-semibold font-['Cairo:SemiBold',_sans-serif]"
                dir="auto"
              >
