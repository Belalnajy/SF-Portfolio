  ...
  return (
    <div className="flex w-full h-[120px] sm:h-[140px] md:h-[160px] lg:h-[180px] xl:h-[200px] lg:w-[180px] xl:w-[200px] flex-col items-center justify-center gap-1 sm:gap-1.5 md:gap-2.5 rounded-[8px] sm:rounded-[10px] md:rounded-[15px] bg-[rgba(44,70,83,0.03)] p-2 sm:p-3">
      ...
      <div className="flex flex-col items-center text-center">
        <p
          className="text-[11px] sm:text-[13px] md:text-[16px] lg:text-[18px] xl:text-[20px] text-[#2c4653] leading-tight font-medium"
          dir="rtl"
        >
          {title}
        </p>
        <p
          className="text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px] text-[rgba(44,70,83,0.8)] leading-tight"
          dir="rtl"
        >
          {value}
        </p>
