...
export function AboutSection() {
  return (
    ...
    {/* For Mobile */}
      <section className="relative py-12 sm:py-16 md:py-20 lg:py-[80px] overflow-hidden block md:hidden" style={{    paddingBottom: 0}}>
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-[40px]">
  ...
  return (
    <div className="relative w-full" dir="rtl">
      <p className="text-[rgba(44,70,83,0.8)] text-[14.6px] sm:text-sm md:text-lg lg:text-[30px] font-semibold opacity-70  text-right leading-relaxed">
        ...
        {" هو نظام تسوّق مبتكر يمنحك تجربة سلسة وذكية، حيث تستمتع بالعروض والخصومات الحصرية، وتتسوّق بخدمة ذاتية توفر لك الخصوصية والراحة، مع حلول دفع سريعة وآمنة تتيح لك إنهاء مشترياتك دون طوابير أو تأخير، لتجعل كل زيارة للمتجر أكثر متعة وسهولة."}
      </p>
    </div>
  );
}
