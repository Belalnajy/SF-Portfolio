...
function Title() {
  return (
    <div
      className="absolute box-border content-stretch flex flex-col font-['Cairo:Bold',_sans-serif] font-bold items-center justify-center leading-[normal] left-[calc(50%+17.5px)] not-italic pb-[8px] pt-0 px-0 text-nowrap text-right top-[132px] translate-x-[-50%] whitespace-pre"
      data-name="TITLE"
    >
...
function Lang({ onClick }: { onClick: () => void }) {
  return (
    ...
    >
      <p
        className="font-['Cairo:Bold',_sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[20px] text-nowrap text-white whitespace-pre"
        dir="auto"
      >
...
function Text({ onDownloadClick }: { onDownloadClick: () => void }) {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[10px] items-center justify-center left-[calc(50%+17.5px)] top-[790px] translate-x-[-50%] w-[700px]"
      data-name="text"
    >
      <p
        className="font-['Cairo:SemiBold',_sans-serif] font-semibold leading-[normal] not-italic relative shrink-0 text-[20px] text-[rgba(44,70,83,0.7)] text-nowrap text-right whitespace-pre"
        dir="auto"
      >
...
function Content() {
  return (
    <div
      className="content-stretch flex flex-col gap-[3px] items-center justify-center leading-[normal] not-italic relative shrink-0 text-[#2c4653]"
      data-name="content"
    >
      <p
        className="font-['Cairo:Bold',_sans-serif] font-bold relative shrink-0 text-[20px] text-nowrap whitespace-pre"
        dir="auto"
      >
        ابدأ التسوّق بنقرة واحدة
      </p>
      <p
        className="font-['Cairo:Medium',_sans-serif] font-medium relative shrink-0 text-[15px] w-[350px]"
        dir="auto"
      >{`اضغط على زر "العربة" في التطبيق وابدأ رحلتك داخل المتجر.`}</p>
    </div>
  );
}
...
function Item() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[15px] items-center left-[1254px] top-[231px]"
      data-name="item"
    >
      <Done />
      <Content />
...
function Content1() {
  return (
    ...
    >
      ...
      <p
        className="font-['Cairo:Medium',_sans-serif] font-medium relative shrink-0 text-[15px] text-center w-[350px]"
        dir="auto"
      >
...
function Item1() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[15px] items-center left-[calc(50%+206.5px)] top-[326px] translate-x-[-50%]"
      data-name="item"
    >
      <Done1 />
      <Content1 />
...
function Item2() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[15px] items-center left-[596px] top-[260px]"
      data-name="item"
    >
      <Done2 />
      <Content2 />
...
function Done3() {
  return (
    <div
      className="bg-[#5dba47] box-border content-stretch flex flex-col gap-[10px] items-center justify-center px-[3px] py-[5px] relative rounded-[1000px] shrink-0 size-[80px]"
      data-name="done"
    >
      <div
        aria-hidden="true"
        className="absolute border-[5px] border-solid border-white inset-[-5px] pointer-events-none rounded-[1005px]"
      />
      <IonQrCodeSharp />
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <p
        ...
        dir="auto"
      >
        عند الانتهاء، انتقل لمنطقة التغليف وشارك رمز الـ QR الخاص بسلتك. ادفع نقدًا، ببطاقتك البنكية
        أو من خلال التطبيق.
      </p>
    </div>
  );
...
function Item3() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[15px] items-center left-[244px] top-[345px]"
      data-name="item"
    >
      <Done3 />
      <Content3 />
...
function Item4() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[15px] items-center left-[calc(50%-153.5px)] top-[559px] translate-x-[-50%]"
      data-name="item"
    >
      <Done4 />
      <Content4 />
...
function Item5() {
  return (
    <div
      className="absolute content-stretch flex flex-col gap-[15px] items-center left-[1023px] top-[572px]"
      data-name="item"
    >
      <Done5 />
      <Content5 />
  ...
  return (
    <div className="flex flex-col items-center gap-[20px] ">
      ...
      <div className="flex flex-col items-center gap-[8px] text-center">
        <h3 className="text-[#2c4653] text-[20px] font-bold leading-tight">{title}</h3>
    ...
    <>
      <section className="relative w-full min-h-[1000px] lg:h-[1000px] py-0 md:py-[80px] overflow-hidden">
        ...
        <div className="hidden  xl:block absolute" data-name="Vector">
          <div
            className="absolute bottom-[-0.3%] left-[-0.24%] right-0 top-[-0.3%]"
            style={
              {
                '--fill-0': 'rgba(93, 186, 71, 1)',
        ...
        <div className="hidden lg:block absolute h-[410.933px] left-[407.71px] top-[230.25px] w-[1020.79px]">
          <div className="absolute inset-[-0.85%_-0.29%_-0.85%_-0.34%]">
            <svg
              ...
              fill="none"
              preserveAspectRatio="none"
              viewBox="0 0 1028 419"
            >
              <path
                d={svgPaths.p1a167d80}
                id="Vector 20"
        ...
        <div
          className="hidden lg:block absolute h-[275px] left-[1453px] top-[51px] w-[340px]"
          data-name="Vector"
        >
          <div
