...
export function Hero() {
  ...
  return (
    <>
      ...
      <section
        className="block md:hidden relative pt-[130px] pb-[60px] overflow-hidden bg-gradient-to-b from-white to-[#f8fdf6]"
        dir="rtl"
      >
        <div className="container mx-auto px-[20px]">
          <div className="flex flex-col items-center gap-[25px]">
            ...
            <p className="text-[rgba(44,70,83,0.7)] text-[13.6px] font-medium text-right leading-relaxed">
              <span>
                ودع الانتظار في الطوابير الطويلة ... مع
                <span className="text-[#5dba47] font-bold"> Smart & Fast Shopping </span>
                تسوق براحة, اعرف أسعارك وعروضك لحظة بلحظة, وادفع بسرعة بدون إضاعة وقتك. لان وقتك
                أغلى.
              </span>
            </p>
      ...
      <section
        className="hidden md:block lg:block xl:block relative pt-[120px] pb-[80px] overflow-hidden"
        dir="rtl"
      >
            ...
            <div className="order-1 lg:order-2 flex flex-col items-end gap-[30px]">
              ...
              <div className="flex flex-col gap-[30px] items-end w-full max-w-[700px]">
                <p className="text-[rgba(44,70,83,0.6)] text-[24px] font-semibold text-right w-full leading-relaxed">
                  ...
                  <span>
                    ودع الانتظار في الطوابير الطويلة ... مع تسوق براحة, اعرف أسعارك وعروضك لحظة
                    بلحظة, وادفع بسرعة بدون إضاعة وقتك. لان وقتك أغلى.
                  </span>
                </p>
    ...
    <>
      ...
      <div className="absolute h-[422px] right-0 top-[235px] w-[522px] opacity-10 pointer-events-none hidden lg:block">
        <svg className="block size-full" fill="none" viewBox="0 0 523 424">
          <g opacity="0.1">
            <path
              d="M146.093 282.055C146.093 293.57 136.759 302.905 125.246 302.905C113.733 302.905 104.399 293.57 104.399 282.055C104.399 270.54 113.733 261.206 125.246 261.206C136.759 261.206 146.093 270.54 146.093 282.055Z"
              fill="#5DBA47"
            />
            <path
              d="M176.112 209.498C176.112 214.104 172.378 217.838 167.773 217.838C163.168 217.838 159.435 214.104 159.435 209.498C159.435 204.892 163.168 201.158 167.773 201.158C172.378 201.158 176.112 204.892 176.112 209.498Z"
              fill="#5DBA47"
            />
            <path
              d="M159.435 84.3992C159.435 89.0052 155.701 92.7391 151.096 92.7391C146.491 92.7391 142.757 89.0052 142.757 84.3992C142.757 79.7932 146.491 76.0593 151.096 76.0593C155.701 76.0593 159.435 79.7932 159.435 84.3992Z"
              fill="#5DBA47"
            />
          </g>
        </svg>
