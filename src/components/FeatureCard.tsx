  ...
  return (
    <div className="relative w-full max-w-[351px] rounded-[15px] bg-white px-4 pb-4 pt-10 shadow-[0px_2px_6px_0px_rgba(0,0,0,0.1)] mx-auto">
        ...
        <div className="size-[55px]">
          ...
          {iconType === "sales" && (
            <svg className="size-full" fill="none" viewBox="0 0 80 80">
              ...
              <path d={svgPaths.p1baa5500} stroke="#5DBA47" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" />
            </svg>
          )}
          ...
          {iconType === "competitive" && (
            <svg className="size-full" fill="none" viewBox="0 0 55 55">
              ...
              <path d="M7.44792 34.9479H39.5312" stroke="#5DBA47" strokeLinecap="round" strokeWidth="1.5" />
            </svg>
          )}
          {iconType === "queue" && (
            <svg className="size-full" fill="none" viewBox="0 0 55 55">
      ...
      <div className="flex flex-col items-center gap-1.5 text-center">
        <h3 className="text-[20px] text-[#2c4653]" dir="rtl">{title}</h3>
        <p className="text-[18px] text-[rgba(44,70,83,0.8)]" dir="rtl">{description}</p>
      </div>
    </div>
  );
}