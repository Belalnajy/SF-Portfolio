    ...
    <>
      ...
      <section className="relative pt-[130px] md:pt-[150px] pb-12 md:pb-16 lg:pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-[40px] relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <p
                className="text-sm sm:text-base md:text-lg text-[rgba(44,70,83,0.8)] leading-relaxed"
                dir="auto"
              >
              ...
              >
                استثمارات اليوم في{' '}
                <span className="font-bold text-[#5dba47]">Smart & Fast Shopping</span> هي استثمار
                في مستقبل التجارة الذكية في المنطقة
              </p>
            </motion.div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-[40px]">
          ...
          >
            <h2
              className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#2c4653] mb-4"
              dir="auto"
            >
              لماذا تستثمر معنا؟
            </h2>
          ...
          >
            {benefits.map((benefit, index) => (
              ...
              >
                ...
                {/* Description */}
                <p
                  className="text-sm md:text-base text-[rgba(44,70,83,0.7)] leading-relaxed"
                  dir="auto"
                >
                  {benefit.description}
                </p>
