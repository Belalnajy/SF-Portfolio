...
export default function InvestPage({ onSuccess }: FormPageProps) {
  ...
  return (
    <>
      <Header />
      <div className="pt-[100px] md:pt-[120px] pb-8 md:pb-12" style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.01) 0%, rgba(0, 0, 0, 0.01) 100%), linear-gradient(90deg, rgb(255, 255, 255) 0%, rgb(255, 255, 255) 100%)" }}>
        {/* Title */}
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-[40px]">
          <form onSubmit={handleSubmit} className="bg-white rounded-[15px] md:rounded-[20px] shadow-[0px_0px_5px_0px_rgba(0,0,0,0.2)] p-4 sm:p-6 md:p-10 lg:p-[60px] max-w-[1360px] mx-auto">
            {/* Notes */}
                  ...
                  <div className="h-[50px] md:h-[60px] lg:h-[65px] rounded-[12px] md:rounded-[15px] border border-[rgba(44,70,83,0.2)] flex items-center">
                    <div className="flex gap-2 md:gap-[10px] h-full items-center justify-end px-3 md:px-[15px] py-0 w-full">
                      <input
                        ...
                        dir="ltr"
                      />
                      <p className="font-bold text-[#5dba47] text-base md:text-lg lg:text-[18px] shrink-0" dir="auto">
                        +966
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-[40px] mb-6 md:mb-8 lg:mb-[40px]">
              ...
              <div className="flex flex-col gap-1 md:gap-[5px] items-end lg:col-span-2">
                ...
                <div className="relative w-full">
                  ...
                  {errors.storeName && <p className="text-red-500 text-sm mt-1 text-right">{errors.storeName}</p>}
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1 md:gap-[5px] items-end">
                ...
                <div className="relative w-full">
                  <button
                    ...
                    className="bg-[#5dba47] h-[50px] md:h-[60px] lg:h-[65px] rounded-[12px] md:rounded-[15px] w-full flex items-center justify-between px-3 md:px-[15px] py-0 hover:bg-[#4da338] transition-colors"
                  >
                      ...
                      <div className={`transform transition-transform ${isDropdownOpen ? 'rotate-180' : ''}`}>
                        <div className="h-[5px] md:h-[6px] w-[16px] md:w-[20px]">
                          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 8">
                            <path d="M1 1L11 7L21 1" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
                          </svg>
                        </div>
                      </div>
                    </div>
                    <p className="font-semibold text-xs md:text-sm lg:text-[14px] text-right text-white" dir="auto">
                      {formData.storeType}
                    </p>
                  </button>
                  {isDropdownOpen && (
            ...
            <div className="flex justify-center mt-8 md:mt-12 lg:mt-[60px]">
              ...
              >
                <p className="font-bold text-base md:text-lg lg:text-[18px] text-white text-center" dir="auto">
                  إرسال الطلب
                </p>
              </button>
            </div>
